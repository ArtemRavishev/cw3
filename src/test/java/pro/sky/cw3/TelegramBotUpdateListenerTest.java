...
import pro.sky.cw3.listener.TelegramBotUpdatesListener;
import pro.sky.cw3.service.NotificationTaskService;
...
public class TelegramBotUpdateListenerTest {
    ...
    public void handleStartTest() throws URISyntaxException, IOException {
        String json= Files.readString(
               Paths.get(TelegramBotUpdateListenerTest.class.getResource("pro/sky/cw3/text_update.json").toURI()));
    ...
    public void handleValidMessage() throws URISyntaxException, IOException {
        ...
        LocalDateTime actalLocalDateTime = localDateTimeArgumentCaptor.getValue();
        String actualString = stringArgumentCaptor.getValue();
        Long actualLong = longArgumentCaptor.getValue();

        Assertions.assertThat(actalLocalDateTime).isEqualTo(LocalDateTime.of(2022,Month.DECEMBER,31,20,0));
